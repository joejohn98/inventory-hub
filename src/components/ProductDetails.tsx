...
import { ArrowLeft, Truck, Package, Tag, DollarSign, Store, AlertTriangle } from "lucide-react"
          ...
          <div className="p-6 lg:p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                >
                  {product.stock <= 5 ? "Critical Stock" : product.stock <= 10 ? "Low Stock" : "In Stock"}
                </span>
              </div>

              <h1 className="text-2xl md:text-3xl font-bold text-slate-800">{product.name}</h1>
          ...
          <div className="border-t lg:border-t-0 lg:border-l border-slate-200">
            <div className="p-6 lg:p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-slate-800">{product.delivered} units</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-200">
                <h3 className="text-lg font-semibold text-slate-800 mb-4">Record Delivery</h3>

                <div className="flex items-center space-x-4 mb-4">
                  <button
                    onClick={() => setDeliveryAmount((prev) => Math.max(1, prev - 1))}
                  ...
                  <input
                    ...
                    onChange={(e) => setDeliveryAmount(Math.max(1, Number.parseInt(e.target.value) || 1))}
